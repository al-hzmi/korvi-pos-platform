  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          أدخل إجمالي قيمة الاقتناء للكمية الظاهرة فقط. يطابق الخادم مراجعات المخزون والتكلفة
          والكمية المجهولة تحت القفل؛ وإذا تغيّرت يرفض القرار ويطلب قراءة جديدة. لا تتغير كمية
          المخزون أو مراجعتها بهذا الأمر.
        </p>
      </div>
