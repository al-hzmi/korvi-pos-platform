...
**Split/merge and split-payment restaurant workflows → course sequencing / safe post-fire delta semantics**, continuing from the verified KDS + recipe production + waste foundations without weakening transaction, financial, inventory or fiscal boundaries.
