...
| Transfers/counting | B1 | C1 | A/AR/I/T through 5A; atomic branch transfers and stale-safe absolute counts established; operational UI delivered through 5D with closure gates pending | Inventory | Data Integrity, UX |
| Suppliers/PO/receiving | B1 | C1 | A/AR/I/T through 5B; immutable PO intent, partial receiving, exact accumulators, atomic stock effects and live over-receipt/rollback proof established; operational UI delivered through 5D with closure gates pending | Purchasing | Data Integrity, Audit, UX |
| Costing foundation | B1 | C0 | A/AR/I/T through 5C; explicit unknown provenance, exact valuation conservation, sale/return/transfer/receiving basis and prospective bootstrap authority established; cost UX delivered through 5D with closure gates pending | Inventory/Domain | Financial, Live DB, Security |
| Inventory & purchasing operational UX | B1 | C1 | A/AR/I/T through delivered 5D-A–D at one verified HEAD; no stock or cost authority in the browser; independent review, actual visual-browser evidence and Human Gate remain open, so production readiness is not claimed | POS/Inventory/Purchasing | UX, Security, Performance |
