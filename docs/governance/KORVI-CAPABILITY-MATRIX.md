...
| Recipes/ingredients/consumption | B1 | C0/C1 | RECIPE/BOM FOUNDATION IMPLEMENTED / VERIFIED on `product/post-v1-restaurant-foundation@5ff6a633`: revisioned/idempotent BOM authority, tenant-scoped ingredient validation, nested/self-cycle guards and branch recipe costing that consumes existing inventory cost authority and preserves UNKNOWN cost as unknown. Ingredient stock consumption/production movements are not yet implemented and remain open. | Restaurant/Inventory | Data Integrity, Financial |
