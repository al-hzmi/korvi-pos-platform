...
| Migration Engine / customer data onboarding | B0/B1 | C0/C1 | ADOPTED P0; M0 VERIFIED; Product M1 VERIFIED on `2442de56`; M2 VERIFIED on `9ce8afc54c4336111f4489a4fb03b651bc9fe6c3`; M3 VERIFIED on `fffd2e7d870826428064a85d4e52973aa86ea465`; M4 Supplier Migration VERIFIED on `512c57fc86a61d72e152ae4c1e05d210b70901b3`; **M5 Opening Inventory VERIFIED** on `0fad77ff837fe4677c67bd74cab50be384bda068`. CI `35720975124`: 201 test files / 2,374 tests passed, 30 files / 395 live-only tests skipped. Restricted-runtime PostgreSQL/RLS proof `35720975187`: 6 files / 26 tests passed. M5 resolves branchCode+SKU server-side per tenant, rechecks pristine stock at commit, writes causal `migration-opening-stock` ledger evidence, refuses client UUID/cost authority and preserves opening cost as UNKNOWN absent explicit authority. **CUSTOMER MIGRATION READINESS VERIFIED** for the adopted baseline. M6 ADOPTED for explicit deterministic update/conflict strategies; M7 DEFERRED to real customer demand. | Migration/Onboarding | Data Integrity, Security, Tenant Isolation, Idempotency, Audit, Reconciliation |
